...
interface ConversationCoroutineService {
    ...
    @POST("conversations")
    suspend fun create(@Body request: ConversationRequest): MixinResponse<ConversationResponse>

    @GET("conversations/{id}")
    suspend fun getConversation(@Path("id") id: String): MixinResponse<ConversationResponse>
    ...
    suspend fun update(@Path("id") id: String, @Body request: ConversationRequest): MixinResponse<ConversationResponse>

    @POST("conversations/{id}/exit")
    suspend fun exit(@Path("id") id: String): MixinResponse<ConversationResponse>

    @POST("conversations/{code_id}/join")
    suspend fun join(@Path("code_id") codeId: String): MixinResponse<ConversationResponse>

    @POST("conversations/{id}/rotate")
    suspend fun rotate(@Path("id") id: String): MixinResponse<ConversationResponse>

    @POST("conversations/{id}/mute")
    suspend fun mute(@Path("id") id: String, @Body request: ConversationRequest): MixinResponse<ConversationResponse>
