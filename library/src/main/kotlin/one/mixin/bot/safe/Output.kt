...
fun listUnspentOutputs(botClient: HttpClient, membersHash: String, threshold: Int, kernelAssetId: String): List<Output> {
    return listOutputs(botClient, membersHash, threshold, kernelAssetId, "unspent", 0, 500)
}

fun listOutputs(botClient: HttpClient, membersHash: String, threshold: Int, assetId: String, state: String, offset: Long, limit: Int): List<Output> {
